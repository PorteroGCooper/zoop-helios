...
//////////////////////////////////////////////////////////////////////////
//   		The manager uses default if no config is provided		//
//		YOU CAN SETUP YOUR OWN ARRAYS FOR ANY CONFIGURATION		//
...
$IMConfig['default']['base_url'] = '/public/uploads';
/*
...
$IMConfig['default']['safe_mode'] = false;
...
$IMConfig['default']['thumbnail_prefix'] = '.';
...
$IMConfig['default']['thumbnail_dir'] = '.thumbs';
...
$IMConfig['default']['allow_new_dir'] = true;
...
$IMConfig['default']['allow_upload'] = true;
...
$IMConfig['default']['validate_images'] = false;
...
$IMConfig['default']['default_thumbnail'] = 'img/default.gif';

/*
  Thumbnail dimensions.
*/

$IMConfig['default']['thumbnail_width'] = 96;
$IMConfig['default']['thumbnail_height'] = 96;

/*
  Image Editor temporary filename prefix.
*/

$IMConfig['default']['tmp_prefix'] = '.editor_';
...
// $IMConfig['steve'] = $IMConfig['default'];
// $IMConfig['steve']['base_dir'] = app_logo_path;
// $IMConfig['steve']['base_url'] = SCRIPT_BASE . "/" . app_logo_webpath;
// $IMConfig['steve']['thumbnail_dir'] = ".thumbs";
// $IMConfig['steve']['thumbnail_prefix'] = '.';
?>
