	...
	for ($i=0;$i<$len;$i++){
		...
		else 
		{
			...
			if (isset($this->fonts[$cf]['differences'][$char]))
			{
				...
				{
					echo("we didn't find this character, $char.  It's probably a space");
				}
			}
			else if (isset($this->fonts[$cf]['C'][$char]['WX']))
			{
				//if($char == ord(' ') && $cf == "./pdf/fonts/Helvetica-Bold.afm")
				//{
				//	$w+=$this->fonts[$cf]['C'][$char]['WX'] * 8;
				//}
				//else
			...
			else
			{
				$intval = $char;
				$char = $text[$i];
				//echo("we didn't find this character, $intval: $char.  It's probably a space");
				//print_r($this->fonts[$cf]['C'][ord(' ')]);
			}
		}
	}
	//print_r($this->fonts[$cf]['C'][ord(' ')]);
